...
<div class="col-xl-12 col-lg-12">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">VIP Video Training</h6>
        </div>
        <div class="card-body">       
                    ...
                    <div class="tab-pane active" id="1">
                        ...
                        <table id="videostable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach($video_trainings as $key => $data)
                                <tr>
                                    <td style="width: 320px;">
                                        <div class="container"> 
                                          <iframe class="responsive-iframe" src="{{ $data->link }}"></iframe>
                                        </div>
                                    </td>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">New Video Training Form</h5>
                      ...
                      <form method="POST" action="{{ route('videos-add') }}">
                        ...
                        <div class="form-group">
                         ...
                         <input id="category" type="hidden" name="category" value="vip" >   
