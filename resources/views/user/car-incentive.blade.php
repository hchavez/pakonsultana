...
@section('content')
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Travel Incentives</h1>
          </div>
          <div class="row">
                              ...
                              <div style="color: #000; font-size: 12px;"> <center>{{$ref->name }}</center></div>
                               ...
                               <center>
                                 <?php if (Auth::user()->role = "vip"){ ?>
                                      ...
                                      <button type="button" class="btn btn-primary" data-toggle="modal" <?php if (Auth::user()->incentive_option != "car"){ ?> disabled="" <?php } ?> data-target="#exampleModal-{{$ref->id }}" >Avail Now</button>
                                      <?php }else{ ?>
                                 ...
                                 <?php }else{ ?>
                                   ...
                                   <p>Go To <a href="/profile"> Profile </a> and Upgrade to VIP Package</p>
                                 <?php } ?>
                              </center>
                            </div>
                          </div>
